...
| TITLE                                                                                                           | SECTION_LINK                                                                                  |
|-----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| 1 .  **What is a Pull_Request (PR)?**                                                                           | [` 🔗CHECK CONTENT `](#what-is-a-pull_request-pr)                                            |
...
## What is a Pull_Request (PR)?
- A `Pull_Request (PR)` is a way to propose changes from **your branch** into **another branch** (usually `main`) on platforms like `GitHub` or `GitLab`.
- It lets others **review your code**, **discuss improvements** and **request modifications** before merging.
- Once approved, the changes are merged into the target branch, ensuring **quality** and **collaboration**.
- It acts as both a **review process** and a **record of what changes were made and why**.
<br>
