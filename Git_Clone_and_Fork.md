...
- This allows you to Experiment, Modify, and Add Features to the project without affecting the Original_Repository.
- A Forked_Repository stays linked to the Original_Repository, so you can later Submit Pull Requests to contribute your changes back.
- Forking is commonly used in Open Source Contributions where developers fork a project, make changes in their copy, and then propose updates to the Owner of the Original Repository.
